    ...
    return (
        <Grid
            ...
            <List sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper' }}>
                <ListItem>
                    <ListItemText primary={friend_nickname} primaryTypographyProps={{textAlign: "center"}}/>
                </ListItem>
                <ListItem>
                    <ListItemText primary={friend_username} primaryTypographyProps={{textAlign: "center"}}/>
                </ListItem>
            </List>
